#ifndef _ROS_prodigimover_msgs_Velocities_h
#define _ROS_prodigimover_msgs_Velocities_h
...
namespace prodigimover_msgs
{
  ...
  class Velocities : public ros::Msg
  {
    ...
    const char * getType(){ return "prodigimover_msgs/Velocities"; };
