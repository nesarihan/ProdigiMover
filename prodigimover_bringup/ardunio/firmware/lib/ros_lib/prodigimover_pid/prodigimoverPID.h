#ifndef _ROS_prodigimover_pid_prodigimoverPID_h
#define _ROS_prodigimover_pid_prodigimoverPID_h
...
namespace prodigimover_pid
{

  class prodigimoverPID : public ros::Msg
  {
    public:
      float p;
      float d;
    ...
    const char * getType(){ return "prodigimover_pid/prodigimoverPID"; };
