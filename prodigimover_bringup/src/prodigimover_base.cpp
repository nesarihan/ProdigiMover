...
ProdigiMoverBase::ProdigiMoverBase():
    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &ProdigiMoverBase::velCallback, this);
}

void ProdigiMoverBase::velCallback(const prodigimover_msgs::Velocities& vel)
{
